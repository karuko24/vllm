...
class Mistral3ProcessorAdapter:
    """
...
class Mistral3ProcessingInfo(BaseProcessingInfo):
    ...
    def get_hf_processor(self) -> Mistral3ProcessorAdapter:
        return Mistral3ProcessorAdapter(self.get_tokenizer())
    ...
    def get_vision_config(
        self,
        processor: Optional[Mistral3ProcessorAdapter] = None,
    ):
...
@MULTIMODAL_REGISTRY.register_processor(Mistral3MultiModalProcessor,
...
class VisionTransformer(nn.Module):
    ...
    def forward(
        ...
        if USE_XFORMERS_OPS:
            ...
            raise ImportError("Xformers is required for Mistral3 inference "
...
class Mistral3HFEncoderInfo(VisionEncoderInfo[PixtralVisionConfig]):
...
class Mistral3HFAttention(nn.Module):
...
class Mistral3HFTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.attention = Mistral3HFAttention(config,
                                            quant_config=quant_config,
                                            prefix=f"{prefix}.attention")
        self.feed_forward = Mistral3HFMLP(config,
                                         quant_config=quant_config,
...
class Mistral3HFTransformer(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.layers = nn.ModuleList([
            Mistral3HFTransformerBlock(config=config,
                                      quant_config=quant_config,
...
class Mistral3HFVisionModel(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.transformer = Mistral3HFTransformer(
            config,
            quant_config,
        ...
        if require_post_norm is True:
            msg = "Mistral3HFVisionModel does not have post-layernorm"
